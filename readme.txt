=== SEO 101 Google Keyword Rank Checker ===
Contributors: seo101
Donate link: 
Tags: Seo, seo 101, google rankings, keyword checker, keyword ranking, keywords
...
Check the rankings of your keyword/phrase in Google

== Description ==

Check the SEO rankings of your keyword/phrase in Google. A basic form that allows you to enter the keyword to check for and returns your position in the Google Search Engine (Checks first 100 positions SEO).

This plugin is designed to be quick and easy and checks your Google rankings SEO from your server. This means your server contacts Google to do the search query for checking SEO.

The official page on my website: http://www.seo101.net/seo-101-google-keyword-rank-checker/

Features and related keywords: SEO 101, seo, keyword rankings, keyword checker, check rankings, yoast seo, seo ultimate, seo yoast, ultimate seo, wordpress seo, seo squirrly, seo booster, all in one seo pack. Search Engine Optimization, Rankchecker, Wordpress ranking plugin, YOAST, Rank reporter, SEo rank reporter, track your rankings, yoast.


== Installation ==

1. Upload `seo101_keyword_rank_checker` to the `/wp-content/plugins/` directory and unzip
2. Activate the plugin through the "Plugins" menu in WordPress
3. Use the settings page to run the tool
...
Features and related keywords: seo 101, seo, keyword rankings, keyword checker, check rankings, yoast seo, seo ultimate, seo yoast, ultimate seo, wordpress seo, seo squirrly, seo booster, all in one seo pack. Search Engine Optimazation, Rankchecker, Wordpress ranking plugin. Rank reporter, SEo rank reporter, track your rankings.
